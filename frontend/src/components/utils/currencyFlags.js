export const currencyCode2Emoji = {
    AED: "🇦🇪", AFN: "🇦🇫", ALL: "🇦🇱", AMD: "🇦🇲", ANG: "🇳🇱",
    AOA: "🇦🇴", ARS: "🇦🇷", AUD: "🇦🇺", AWG: "🇦🇼", AZN: "🇦🇿",
    BAM: "🇧🇦", BBD: "🇧🇧", BDT: "🇧🇩", BGN: "🇧🇬", BIF: "🇧🇮",
    BMD: "🇧🇲", BND: "🇧🇳", BOB: "🇧🇴", BRL: "🇧🇷", BSD: "🇧🇸",
...
export const currency2CountryCodes = {
    ...
    CNH: "CN", CNY: "CN", COP: "CO", CRC: "CR", CUC: "CU",
    ...
    MRO: "MR", MRU: "MR", MUR: "MU", MVR: "MV", MWK: "MW",
    ...
    SDG: "SD", SEK: "SE", SGD: "SG", SHP: "SH", SLL: "SL",
    SOS: "SO", SRD: "SR", SSP: "SS", STD: "ST", STN: "ST",
    ...
    WST: "WS", XAF: "CM", XAG: "XA", XAU: "XA", XCD: "AI",
    XDR: "XD", XPD: "XP", XPT: "XP", XOF: "BJ", XPF: "PF",
...
export function getFlagEmojiCharCode(countryCode) {
    return countryCode.toUpperCase().replace(/./g, char =>
        String.fromCodePoint(127397 + char.charCodeAt())
    );
  }

export function getFlagEmoji(currencyCode) {
    const countryCode = currency2CountryCodes[currencyCode]
    return countryCode? getFlagEmojiCharCode(countryCode): ""
}

export function countryFlags() {
    return(
        Object.keys(currency2CountryCodes).map(
            item => {
                return([item + " " + getFlagEmoji(item)])
            }
        )
    )
}
